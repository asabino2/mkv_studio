...
const LANGUAGE_MAP = {
  pt: { code6392: 'por', code6391: 'pt', name: 'Português' },
  por: { code6392: 'por', code6391: 'pt', name: 'Português' },
  'pt-br': { code6392: 'por', code6391: 'pt', name: 'Português (BR)' },
  en: { code6392: 'eng', code6391: 'en', name: 'English' },
  eng: { code6392: 'eng', code6391: 'en', name: 'English' },
  es: { code6392: 'spa', code6391: 'es', name: 'Español' },
  spa: { code6392: 'spa', code6391: 'es', name: 'Español' },
  fr: { code6392: 'fre', code6391: 'fr', name: 'Français' },
  fre: { code6392: 'fre', code6391: 'fr', name: 'Français' },
  de: { code6392: 'ger', code6391: 'de', name: 'Deutsch' },
  ger: { code6392: 'ger', code6391: 'de', name: 'Deutsch' },
  it: { code6392: 'ita', code6391: 'it', name: 'Italiano' },
  ita: { code6392: 'ita', code6391: 'it', name: 'Italiano' },
...
function detectSubtitleLanguage(filePath) {
  ...
  return { code6392: 'und', code6391: 'un', name: 'Indefinido', source: 'default', encoding };
}
...
function detectAudioLanguage(filePath) {
  ...
  return { code6392: 'und', code6391: 'un', name: 'Indefinido', source: 'default' };
}
